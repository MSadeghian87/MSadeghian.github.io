...
<body class="text-white" style="background-color:#175582;">
    <header style="height:500px;">
        ...
        <div style="width:100%; position:relative;">
            <img src="header1.png" style="width:100%; position:absolute; z-index:1; left:0; top:0; -webkit-mask-image:-webkit-gradient(linear, left top, left bottom, from(rgba(0,0,0,1)), to(rgba(0,0,0,0.1))); mask-image: linear-gradient(to bottom, rgba(0,0,0,1), rgba(0,0,0,0.1));"
            />
